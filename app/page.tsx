      ...
      <div className="Block-1">
        ...
        <div className="Block-1-Text">
          <div className="Block-1-Text-Blur">
            ...
            <p>
              Сократите расходы на удобрения до 30% с помощью ДЗЗ. Используем
          ...
          <div className="Block-4-SubBlock">
            ...
            <div className="Block-4-SubText">
              ...
              <p>
                ...
                спутника "Лобачевский" и агрохимическиие данные почв.
              </p>
            </div>
          </div>
